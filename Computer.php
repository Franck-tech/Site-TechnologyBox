                 ...
                 <div class="col-md-12">
                  <div class="col-md-12">
                       ...
                       <?php
                            ...
                            <section class="main">
                            <div class="content" style='margin: 50px 5px 10px 10px;height: 450px; margin-bottom:0px; '>
                           <div class="card" style='width:300px;border-radius:10px; height:390px; padding:0px;'>
                            ...
                            <a href=""><img src="assets/img/computer/<?= $row['image'] ?>" alt=""
                              ...
                              <input type="number" name="Quantity" value="1" class="form-control-center"
                              ...
                              <input type="submit" name="Add_To_Cart" class="btn btn-warning my-2" value="Add to Basket"
                               style= 'Background-color:rgb(177, 209, 177); width:300px;border-radius: 5px 5px 10px 10px; border:green;margin-bottom:0px'>
                              </form>
                              </div>
                         </div>
                         </div>  
